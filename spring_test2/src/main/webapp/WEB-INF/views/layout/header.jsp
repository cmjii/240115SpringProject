    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="justify-content-center navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <c:choose>
	        ...
	        <li class="nav-item">
	          <a class="nav-link" href="/member/list">회원 리스트 ${authNick }(${authEmail } / ADMIN)</a> <!-- 컨트롤러 경로로 가는거임 -->
	        </li>
	       <li class="nav-item ">
        	  <a class="nav-link active" aria-current="page" href="/member/modify">정보수정</a>
        	</li>
	        </c:when>
	        <c:otherwise>
	        <li class="nav-item ">
        	  <a class="nav-link active" aria-current="page" href="/member/modify">정보수정 ${authNick }(${authEmail })</a>
        	</li>
	        </c:otherwise>
        </c:choose>
